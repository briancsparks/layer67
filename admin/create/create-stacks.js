...
//        });
        ...
        return awsService('EC2', 'prod').describeVpcs({}, enext(function(err, data) {
      ...
      // Completion for when the __eachll finishes both template
      }, function() {
...
function chgOctet4(ip, o4) {
  var parts = ip.spilt('/')[0].split('.');
  parts[3] = o4;
  return parts.join('.');
}
