...
_.each(libFiles, file => {
  var   library   = require(file);
  const commands  = sg.extract(library, 'cmds');

  _.extend(cmds, commands);
  _.extend(lib, library);
});

//console.log('commands: ', _.keys(cmds));
//console.log('library: ', _.keys(lib));
